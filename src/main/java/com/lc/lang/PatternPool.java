...
public class PatternPool {
     ...
     * 单个中文汉字
     */
    public final static Pattern CHINESE = Pattern.compile(UReUtil.RE_CHINESE);
    /**
     * 中文汉字
     */
    public final static Pattern CHINESES = Pattern.compile(UReUtil.RE_CHINESES);
    /**
     * 分组
     */
