...
public final class UUID implements java.io.Serializable, Comparable<UUID> {
    ...
    private static class Holder {
        static final SecureRandom numberGenerator = URandomUtil.getSecureRandom();
    }
    ...
    public static UUID randomUUID(boolean isSecure) {
        final Random ng = isSecure ? Holder.numberGenerator : URandomUtil.getRandom();
    ...
    public String toString(boolean isSimple) {
        final StringBuilder builder = UStringUtil.builder(isSimple ? 32 : 36);
        // time_low
