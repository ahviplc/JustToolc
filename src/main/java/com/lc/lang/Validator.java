...
import com.lc.exception.ValidateException;
import com.lc.utils.*;
...
public class Validator {
    ...
    public static boolean isEmpty(Object value) {
        return (null == value || (value instanceof String && UStringUtil.isEmpty((String) value)));
    }
    ...
    public static boolean equal(Object t1, Object t2) {
        return UObjectUtil.equal(t1, t2);
    }
    ...
    public static boolean isMactchRegex(String regex, String value) {
        return UReUtil.isMatch(regex, value);
    }
    ...
    public static boolean isMactchRegex(Pattern pattern, String value) {
        return UReUtil.isMatch(pattern, value);
    }
    ...
    public static boolean isLetter(String value) {
        return UStringUtil.isAllCharMatch(value, new com.lc.lang.Matcher<Character>() {
            @Override
    ...
    public static boolean isNumber(String value) {
        return UNumberUtil.isNumber(value);
    }
    ...
    public static boolean isBirthday(int year, int month, int day) {
        // 验证年
        int thisYear = UDateUtil.thisYear();
        ...
        if (month == 2) {
            if (day > 29 || (day == 29 && false == UDateUtil.isLeapYear(year))) {
                return false;
            }
        }
        return true;
    ...
    public static boolean isChinese(String value) {
        return isMactchRegex("^" + UReUtil.RE_CHINESE + "+$", value);
    }
