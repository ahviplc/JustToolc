...
public class UHexUtil {
    ...
    public static char[] encodeHex(String str, Charset charset) {
        return encodeHex(UStringUtil.bytes(str, charset), true);
    }
    ...
    public static String encodeHexStr(String data, Charset charset) {
        return encodeHexStr(UStringUtil.bytes(data, charset), true);
    }
    ...
    public static String encodeHexStr(String data) {
        return encodeHexStr(data, UCharsetUtil.CHARSET_UTF_8);
    }
    ...
    public static String decodeHexStr(String hexStr) {
        return decodeHexStr(hexStr, UCharsetUtil.CHARSET_UTF_8);
    }
    ...
    public static String decodeHexStr(char[] hexData, Charset charset) {
        return UStringUtil.str(decodeHex(hexData), charset);
    }
