...
import com.lc.core.StrSpliter;
import com.lc.core.comparator.VersionComparator;
...
public class UStringUtil {
    ...
    public static final char C_SPACE = UCharUtil.SPACE;
    public static final char C_TAB = UCharUtil.TAB;
    public static final char C_DOT = UCharUtil.DOT;
    public static final char C_SLASH = UCharUtil.SLASH;
    public static final char C_BACKSLASH = UCharUtil.BACKSLASH;
    public static final char C_CR = UCharUtil.CR;
    public static final char C_LF = UCharUtil.LF;
    public static final char C_UNDERLINE = UCharUtil.UNDERLINE;
    public static final char C_COMMA = UCharUtil.COMMA;
    public static final char C_DELIM_START = UCharUtil.DELIM_START;
    public static final char C_DELIM_END = UCharUtil.DELIM_END;
    public static final char C_BRACKET_START = UCharUtil.BRACKET_START;
    public static final char C_BRACKET_END = UCharUtil.BRACKET_END;
    public static final char C_COLON = UCharUtil.COLON;
    ...
    public static boolean isBlank(CharSequence str) {
        ...
        for (int i = 0; i < length; i++) {
            // 只要有一个非空字符即为非空字符串
            if (false == UCharUtil.isBlankChar(str.charAt(i))) {
                return false;
            }
        }
        return true;
    ...
    public static boolean startWithAny(CharSequence str, CharSequence... prefixes) {
        if (isEmpty(str) || UArrayUtil.isEmpty(prefixes)) {
            return false;
        }
    ...
    public static boolean endWithAny(CharSequence str, CharSequence... suffixes) {
        if (isEmpty(str) || UArrayUtil.isEmpty(suffixes)) {
            return false;
        }
    ...
    public static boolean containsAny(CharSequence str, char... testChars) {
        if (false == isEmpty(str)) {
            int len = str.length();
            for (int i = 0; i < len; i++) {
                if (UArrayUtil.contains(testChars, str.charAt(i))) {
                    return true;
                }
            }
        }
    ...
    public static String getContainsStr(CharSequence str, CharSequence... testStrs) {
        if (isEmpty(str) || UArrayUtil.isEmpty(testStrs)) {
            return null;
        }
    ...
    public static String cleanBlank(CharSequence str) {
        ...
        for (int i = 0; i < len; i++) {
            c = str.charAt(i);
            if (false == UCharUtil.isBlankChar(c)) {
                sb.append(c);
            }
        }
        return sb.toString();
    ...
    public static String subPreGbk(CharSequence str, int len, CharSequence suffix) {
        ...
        b = str.toString().getBytes(UCharsetUtil.CHARSET_GBK);
        if (b.length <= len) {
            return str.toString();
        }
        for (int i = 0; i < len; i++) {
        ...
        return new String(b, 0, len, UCharsetUtil.CHARSET_GBK) + suffix;
    }
    ...
    public static String format(CharSequence template, Object... params) {
        ...
        if (UArrayUtil.isEmpty(params) || isBlank(template)) {
    ...
    public static byte[] utf8Bytes(CharSequence str) {
        return bytes(str, UCharsetUtil.CHARSET_UTF_8);
    }
    ...
    public static String utf8Str(Object obj) {
        return str(obj, UCharsetUtil.CHARSET_UTF_8);
    }
    ...
    public static String str(Object obj, Charset charset) {
        ...
        } else if (UArrayUtil.isArray(obj)) {
            return UArrayUtil.toString(obj);
        }
     ...
     * @param objs        数组
     * @return 连接后的字符串
     * @see UArrayUtil#join(Object, CharSequence)
     */
    public static String join(CharSequence conjunction, Object... objs) {
        return UArrayUtil.join(objs, conjunction);
    }
    ...
    public static String toUnderlineCase(CharSequence str) {
        return toSymbolCase(str, UCharUtil.UNDERLINE);
    }
    ...
    public static boolean isWrap(CharSequence str, String prefix, String suffix) {
        if (UArrayUtil.hasNull(str, prefix, suffix)) {
            return false;
        }
        final String str2 = str.toString();
    ...
    public static String[] cut(CharSequence str, int partLength) {
        ...
        int part = UNumberUtil.count(len, partLength);
     ...
     * 如果 str等于null 或 searchStr等于null 或 ordinal小于等于0 则返回-1<br>
    ...
    public static String reverse(String str) {
        return new String(UArrayUtil.reverse(str.toCharArray()));
    }
    ...
    public static String fill(String str, char filledChar, int len, boolean isPre) {
        ...
        String filledStr = UStringUtil.repeat(filledChar, len - strLen);
    ...
    public static String replaceChars(CharSequence str, char[] chars, CharSequence replacedStr) {
        if (isEmpty(str) || UArrayUtil.isEmpty(chars)) {
            return str(str);
        }
     ...
     *
     * @return UUID字符串
     * @see UIdUtil#randomUUID()
     */
    public static String uuid() {
        return UIdUtil.randomUUID();
    }
