...
public class UCharsetUtil {
    ...
    public static Charset charset(String charsetName) throws UnsupportedCharsetException {
        return UStringUtil.isBlank(charsetName) ? Charset.defaultCharset() : Charset.forName(charsetName);
    }
    ...
    public static String convert(String source, Charset srcCharset, Charset destCharset) {
        ...
        if (UStringUtil.isBlank(source) || srcCharset.equals(destCharset)) {
            return source;
        }
    ...
    public static File convert(File file, Charset srcCharset, Charset destCharset) {
        ...
        return UFileUtil.writeString(str, file, destCharset);
    }

    /**
     * 系统字符集编码，如果是Windows，则默认为GBK编码，否则取 {@link UCharsetUtil#defaultCharsetName()}
     *
     * @return 系统字符集编码
