...
public class TextSimilarity {
    ...
    public static double similar(String strA, String strB) {
        ...
        return UNumberUtil.div(temp2, temp);
    }
    ...
    public static String similar(String strA, String strB, int scale) {
        return UNumberUtil.formatPercent(similar(strA, strB), scale);
    }
    ...
    private static String removeSign(String str) {
        StringBuilder sb = UStringUtil.builder(str.length());
