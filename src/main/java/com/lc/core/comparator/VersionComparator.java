package com.lc.core.comparator;
...
public class VersionComparator implements Comparator<String>, Serializable {
    ...
    public int compare(String version1, String version2) {
        ...
        final List<String> v1s = UStringUtil.split(version1, UCharUtil.DOT);
        final List<String> v2s = UStringUtil.split(version2, UCharUtil.DOT);
