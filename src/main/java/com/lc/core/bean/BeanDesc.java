...
public class BeanDesc {
    ...
    private BeanDesc init() {
        for (Field field : UReflectUtil.getFields(this.beanClass)) {
            if (false == UModifierUtil.isStatic(field)) {
                //只针对非static属性
    ...
    private PropDesc createProp(Field field) {
        ...
        for (Method method : UReflectUtil.getMethods(this.beanClass)) {
    ...
    private boolean isMatchSetter(String methodName, String fieldName, boolean isBooeanField) {
        ...
        if (isBooeanField && fieldName.startsWith("is")) {
            // 字段是is开头
            if (methodName.equals("set" + UStringUtil.removePrefix(fieldName, "is"))// isName -》 setName
    ...
    public static class PropDesc {
        ...
        public PropDesc(Field field, Method getter, Method setter) {
            this.field = field;
            this.getter = UClassUtil.setAccessible(getter);
            this.setter = UClassUtil.setAccessible(setter);
        }
        ...
        public Type getFieldType() {
            if (null != this.field) {
                return UTypeUtil.getType(this.field);
            }
        ...
        public Class<?> getFieldClass() {
            if (null != this.field) {
                return UTypeUtil.getClass(this.field);
            }
        ...
        public Object getValue(Object bean) {
            if (null != this.getter) {
                return UReflectUtil.invoke(bean, this.getter);
            } else if (UModifierUtil.isPublic(this.field)) {
                return UReflectUtil.getFieldValue(bean, this.field);
            }
            return null;
        }
        ...
        public PropDesc setValue(Object bean, Object value) {
            if (null != this.setter) {
                UReflectUtil.invoke(bean, this.setter, value);
            } else if (UModifierUtil.isPublic(this.field)) {
                UReflectUtil.setFieldValue(bean, this.field, value);
            }
            return this;
        }
        ...
        private Type findPropType(Method getter, Method setter) {
            Type type = null;
            if (null != getter) {
                type = UTypeUtil.getReturnType(getter);
            }
            if (null == type && null != setter) {
                type = UTypeUtil.getParamType(setter, 0);
            }
            return type;
        }
        ...
        private Class<?> findPropClass(Method getter, Method setter) {
            Class<?> type = null;
            if (null != getter) {
                type = UTypeUtil.getReturnClass(getter);
            }
            if (null == type && null != setter) {
                type = UTypeUtil.getFirstParamClass(setter);
            }
            return type;
        }
    }
