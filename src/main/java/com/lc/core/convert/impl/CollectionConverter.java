...
import com.lc.core.convert.Converter;
...
public class CollectionConverter implements Converter<Collection<?>> {
    ...
    public CollectionConverter(Type collectionType) {
        this(collectionType, UTypeUtil.getTypeArgument(collectionType));
    }
    ...
    protected Collection<?> convertInternal(Object value) {
        final Collection<Object> collection = UCollUtil.create(UTypeUtil.getClass(collectionType));
        return UCollUtil.addAll(collection, value, elementType);
    }
}
