...
import com.lc.core.convert.impl.CollectionConverter;
import com.lc.core.convert.impl.GenericEnumConverter;
import com.lc.exception.ConvertException;
import com.lc.utils.*;
...
public class Convert {
    ...
    public static <T> T convertByClassName(String className, Object value) throws ConvertException {
        return (T) convert(UClassUtil.loadClass(className), value);
    }
     ...
     * @param charset 编码
     * @return 16进制字符串
     * @see UHexUtil#encodeHexStr(String, Charset)
     */
    public static String toHex(String str, Charset charset) {
        return UHexUtil.encodeHexStr(str, charset);
    }
     ...
     * @return 转换后的值
     * @see UHexUtil#encodeHexStr(byte[])
     */
    public static String toHex(byte[] bytes) {
        return UHexUtil.encodeHexStr(bytes);
    }
     ...
     * @return byte[]
     * @see UHexUtil#decodeHex(char[])
     */
    public static byte[] hexToBytes(String src) {
        return UHexUtil.decodeHex(src.toCharArray());
    }
     ...
     * @return 对应的字符串
     * @see UHexUtil#decodeHexStr(String, Charset)
    ...
    public static String hexToStr(String hexStr, Charset charset) {
        return UHexUtil.decodeHexStr(hexStr, charset);
    }
     ...
     * @see UUnicodeUtil#toUnicode(String)
     */
    public static String strToUnicode(String strText) {
        return UUnicodeUtil.toUnicode(strText);
    }
     ...
     * @return String 字符串
     * @see UUnicodeUtil#toString(String)
     */
    public static String unicodeToStr(String unicode) {
        return UUnicodeUtil.toString(unicode);
    }
     ...
     * @return 转换后的字符串
     * @see UCharsetUtil#convert(String, String, String)
     */
    public static String convertCharset(String str, String sourceCharset, String destCharset) {
        if (UStringUtil.hasBlank(str, sourceCharset, destCharset)) {
            return str;
        }

        return UCharsetUtil.convert(str, sourceCharset, destCharset);
    }
